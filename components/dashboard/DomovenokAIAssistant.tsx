  ...
  return (
    <div className="fixed inset-0 w-full h-full">
      <div className="h-full w-full flex flex-col bg-white dark:bg-slate-900">
        {/* Header */}
        <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-2 py-4">
        ...
        {/* Input Area */}
        <div className="px-2 py-4 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
          <div className="flex items-center space-x-4">
